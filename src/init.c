...
/*   Updated: 2021/11/18 10:58:14 by oronda           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->wall_img = mlx_xpm_file_to_image(data->mlx, "sprites/mur_3.xpm",
			&data->img_size.x, &data->img_size.y);
	data->floor_img = mlx_xpm_file_to_image(data->mlx, "sprites/sol.xpm",
			&data->img_size.x, &data->img_size.y);
